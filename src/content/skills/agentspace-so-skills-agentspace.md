---
name: Agentspace
tagline: "See what your AI agent is doing, from anywhere. The agent keeps writing — logs, code, generated outputs, screenshots, artifacts. One command turns the folder in"
url: "https://skills.sh/agentspace-so/skills/agentspace"
github: "agentspace-so/skills"
author: "agentspace-so"
tags:
  - "claude-code"
  - "agentspace-so"
kind: "claude-code-skill"
install: "npx skills add agentspace-so/skills --skill agentspace"
addedAt: "2026-05-05"
---
