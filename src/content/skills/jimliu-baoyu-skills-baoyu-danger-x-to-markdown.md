...
tagline: "Converts X (Twitter) tweets and articles to markdown with YAML front matter. Uses reverse-engineered API requiring user consent. Use when user mentions \"X to ma"
...
install: "npx skills add jimliu/baoyu-skills --skill baoyu-danger-x-to-markdown"
addedAt: "2026-05-05"
---
