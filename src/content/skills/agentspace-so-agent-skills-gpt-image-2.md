---
name: Gpt Image 2
tagline: "Generate images with GPT Image 2 (ChatGPT Images 2.0) inside Claude Code, using your existing ChatGPT Plus or Pro subscription — no separate OpenAI access, no p"
url: "https://skills.sh/agentspace-so/agent-skills/gpt-image-2"
github: "agentspace-so/agent-skills"
author: "agentspace-so"
tags:
  - "claude-code"
  - "agentspace-so"
kind: "claude-code-skill"
install: "npx skills add agentspace-so/agent-skills --skill gpt-image-2"
addedAt: "2026-05-05"
---
