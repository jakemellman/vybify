...
tagline: "Fetch any URL and convert to markdown using baoyu-fetch CLI (Chrome CDP with site-specific adapters). Built-in adapters for X/Twitter, YouTube transcripts, Hack"
...
install: "npx skills add jimliu/baoyu-skills --skill baoyu-url-to-markdown"
addedAt: "2026-05-05"
---
