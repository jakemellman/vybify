...
tagline: Read content from a Google Doc and use it as the body of a Gmail message.
...
install: "npx skills add googleworkspace/cli --skill recipe-draft-email-from-doc"
addedAt: "2026-05-05"
---
