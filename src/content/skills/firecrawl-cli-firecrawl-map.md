---
name: Firecrawl Map
tagline: "Discover and list all URLs on a website, with optional search filtering. Use this skill when the user wants to find a specific page on a large site, list all UR"
...
install: "npx skills add firecrawl/cli --skill firecrawl-map"
addedAt: "2026-05-05"
---
