...
tagline: "Deploy and manage projects on Vercel using token-based authentication. Use when working with Vercel CLI using access tokens rather than interactive login — e.g."
...
install: "npx skills add vercel-labs/agent-skills --skill vercel-cli-with-tokens"
addedAt: "2026-05-05"
---
