...
tagline: "Starter templates for common Claude API patterns — agents, RAG, tool use, and more."
...
[Go to Customer Support Agent Quickstart](https://github.com/anthropics/anthropic-quickstarts/blob/HEAD/customer-support-agent)
...
[Go to Financial Data Analyst Quickstart](https://github.com/anthropics/anthropic-quickstarts/blob/HEAD/financial-data-analyst)
...
[Go to Computer Use Demo Quickstart](https://github.com/anthropics/anthropic-quickstarts/blob/HEAD/computer-use-demo)
...
[Go to Browser Tools API Demo Quickstart](https://github.com/anthropics/anthropic-quickstarts/blob/HEAD/browser-tools-api-demo)
...
[Go to Autonomous Coding Agent Quickstart](https://github.com/anthropics/anthropic-quickstarts/blob/HEAD/autonomous-coding)
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/anthropics/anthropic-quickstarts/blob/HEAD/LICENSE) file for details.
