...
tagline: "A universal self-improving agent that learns from ALL skill experiences. Uses multi-memory architecture (semantic + episodic + working) to continuously evolve t"
url: "https://skills.sh/charon-fan/agent-playbook/self-improving-agent"
github: "charon-fan/agent-playbook"
author: "charon-fan"
tags:
  - "claude-code"
  - "charon-fan"
kind: "claude-code-skill"
install: "npx skills add charon-fan/agent-playbook --skill self-improving-agent"
addedAt: "2026-05-05"
---
