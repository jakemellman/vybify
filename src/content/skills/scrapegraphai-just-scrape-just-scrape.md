---
name: Just Scrape
tagline: "Search, scrape, crawl, extract structured data, and monitor web pages via the ScrapeGraph AI CLI. Use when the user asks to search the web, scrape a webpage, gr"
url: "https://skills.sh/scrapegraphai/just-scrape/just-scrape"
github: "scrapegraphai/just-scrape"
author: scrapegraphai
tags:
  - "claude-code"
  - scrapegraphai
kind: "claude-code-skill"
install: "npx skills add scrapegraphai/just-scrape --skill just-scrape"
addedAt: "2026-05-05"
---
