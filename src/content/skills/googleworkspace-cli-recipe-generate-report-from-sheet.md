...
tagline: Read data from a Google Sheet and create a formatted Google Docs report.
...
install: "npx skills add googleworkspace/cli --skill recipe-generate-report-from-sheet"
addedAt: "2026-05-05"
---
