---
name: Memory Merger
tagline: "Merges mature lessons from a domain memory file into its instruction file. Syntax: `/memory-merger >domain [scope]` where scope is `global` (default), `user`, `"
...
install: "npx skills add github/awesome-copilot --skill memory-merger"
addedAt: "2026-05-05"
---
