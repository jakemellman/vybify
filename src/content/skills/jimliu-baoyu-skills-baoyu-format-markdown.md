...
tagline: "Formats plain text or markdown files with frontmatter, titles, summaries, headings, bold, lists, and code blocks. Use when user asks to \"format markdown\", \"beau"
...
install: "npx skills add jimliu/baoyu-skills --skill baoyu-format-markdown"
addedAt: "2026-05-05"
---
