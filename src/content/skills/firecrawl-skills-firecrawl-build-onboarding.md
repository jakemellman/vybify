...
tagline: "Get Firecrawl credentials and SDK setup into a project. Use when an application needs `FIRECRAWL_API_KEY`, when an agent should add Firecrawl to `.env`, when th"
...
install: "npx skills add firecrawl/skills --skill firecrawl-build-onboarding"
addedAt: "2026-05-05"
---
