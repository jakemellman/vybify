...
tagline: Create a Google Drive folder structure and move files into the right locations.
...
install: "npx skills add googleworkspace/cli --skill recipe-organize-drive-folder"
addedAt: "2026-05-05"
---
