...
tagline: "Develop AI-powered applications using Genkit in Go. Use when the user asks to build AI features, agents, flows, or tools in Go using Genkit, or when working wit"
...
install: "npx skills add firebase/agent-skills --skill developing-genkit-go"
addedAt: "2026-05-05"
---
