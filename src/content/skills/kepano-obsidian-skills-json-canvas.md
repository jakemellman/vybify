---
name: Json Canvas
tagline: "Create and edit JSON Canvas files (.canvas) with nodes, edges, groups, and connections. Use when working with .canvas files, creating visual canvases, mind maps"
...
install: "npx skills add kepano/obsidian-skills --skill json-canvas"
addedAt: "2026-05-05"
---
